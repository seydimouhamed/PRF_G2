 ...
 */
final class Version20200827174323 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE livrable_partiel_apprenant (id INT AUTO_INCREMENT NOT NULL, fil_id INT DEFAULT NULL, delais DATE NOT NULL, etat VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5B1B461313BD0C41 (fil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
