 ...
 */
final class Version20200822184408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE brief (id INT AUTO_INCREMENT NOT NULL, referentiel_id INT NOT NULL, formateur_id INT NOT NULL, titre VARCHAR(255) NOT NULL, contexte LONGTEXT NOT NULL, date_poste DATE NOT NULL, date_limite DATE NOT NULL, liste_livrable LONGTEXT DEFAULT NULL, description_rapide LONGTEXT NOT NULL, modalite_pedagogique LONGTEXT NOT NULL, crictere_performance LONGTEXT NOT NULL, modalite_devaluation LONGTEXT NOT NULL, image_exemplaire LONGBLOB DEFAULT NULL, langue VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, archivage TINYINT(1) DEFAULT \'0\' NOT NULL, INDEX IDX_1FBB1007805DB139 (referentiel_id), INDEX IDX_1FBB1007155D8F51 (formateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livrable_attendus (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, url LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE apprenant_livrable_partiels DROP FOREIGN KEY FK_B3EC6288C5697D6D');
        $this->addSql('ALTER TABLE apprenant_livrable_attendus DROP FOREIGN KEY FK_BAD746EDC5697D6D');
        ...
        $this->addSql('ALTER TABLE apprenant_livrable_attendus DROP FOREIGN KEY FK_BAD746ED75D62BB4');
        $this->addSql('ALTER TABLE brief_livrable_attendus DROP FOREIGN KEY FK_2402D7A275D62BB4');
        $this->addSql('ALTER TABLE apprenant_livrable_partiels DROP FOREIGN KEY FK_B3EC62887B292AF4');
