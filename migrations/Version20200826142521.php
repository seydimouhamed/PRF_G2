 ...
 */
final class Version20200826142521 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apprenant (id INT NOT NULL, profil_sortie_id INT DEFAULT NULL, livrable_attendu_apprenant_id INT DEFAULT NULL, livrable_partiel_apprenant_id INT DEFAULT NULL, genre VARCHAR(30) NOT NULL, adresse LONGTEXT NOT NULL, telephone VARCHAR(50) NOT NULL, statut VARCHAR(50) DEFAULT \'attente\' NOT NULL, INDEX IDX_C4EB462E6409EF73 (profil_sortie_id), INDEX IDX_C4EB462EEE63D1F4 (livrable_attendu_apprenant_id), INDEX IDX_C4EB462E5467F92D (livrable_partiel_apprenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livrable_attendus (id INT AUTO_INCREMENT NOT NULL, livrable_attendu_apprenant_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, INDEX IDX_F90C2D23EE63D1F4 (livrable_attendu_apprenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livrable_partiels (id INT AUTO_INCREMENT NOT NULL, livrable_partiel_apprenant_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, delai DATE NOT NULL, date_creation DATE NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_F03709465467F92D (livrable_partiel_apprenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
