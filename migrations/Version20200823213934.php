 ...
 */
final class Version20200823213934 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chat (id INT AUTO_INCREMENT NOT NULL, apprenant_id INT DEFAULT NULL, message LONGTEXT NOT NULL, piece_jointes LONGBLOB DEFAULT NULL, date DATE NOT NULL, INDEX IDX_659DF2AAC5697D6D (apprenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
