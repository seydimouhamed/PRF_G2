 ...
 */
final class Version20200822115445 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chat (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, promotion_id INT DEFAULT NULL, message LONGTEXT NOT NULL, piece_jointes LONGBLOB DEFAULT NULL, INDEX IDX_659DF2AAA76ED395 (user_id), INDEX IDX_659DF2AA139DF194 (promotion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
